...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/youcompleteme,~/.vim/plugged/vim-cmake-syntax,~/.vim/plugged/copilot.vim,~/.vim/plugged/vim-epitech,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vim90/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
set scrolloff=5
...
silent only
silent tabonly
cd ~/delivery/DOP/croissant/.github/workflows
...
badd +0 what_time_is_it.yml
argglobal
%argdel
edit what_time_is_it.yml
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 99 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 111 + 105) / 211)
argglobal
balt what_time_is_it.yml
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
terminal ++curwin ++cols=111 ++rows=54 
